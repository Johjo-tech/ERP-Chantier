...
import { TableauSousTraitant, TableauTerrain } from "./TableauTerrain";
...
export function TableauDeBord() {
  ...
  if (genre === "sous_traitant") return <TableauSousTraitant />;
  if (genre === "technicien") return <TableauTerrain nom={nom} />;
