...
export function messageErreur(e: unknown): string {
  ...
  if (e instanceof Error && (e.message.startsWith("Configuration invalide") || ["ErreurFormat", "EnregistrementPartiel", "LectureImpossible", "PreparationImpossible", "SavSansToutesSesPhotos", "ListeTronquee"].includes(e.name))) {
    return e.message;
  }
