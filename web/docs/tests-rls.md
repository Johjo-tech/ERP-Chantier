...
| `statistiques.essai.ts` | CA de février 2012 (sommes mesurées en écart : les pièces émises restent) : ni brouillon ni acompte, avoir en négatif ; restant dû par client sans le crédit d'un avoir ; « encaissé » = règlements du mois hors lettrage ; `stats_bon_ouvert` fermé par une facture liée ; un bon compte dans chacun de ses métiers ; conducteur par sa référence ; garde « statistiques / voir » (technicien, sous-traitant, admin BETA refusés en 42501 ; secrétaire, lecture, conducteur admis, le conducteur sans règlements) ; tableau du conducteur par sa fiche, sans colonne de prix | **oui** (20260926080000) |
