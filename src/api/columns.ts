...
const COLONNES: Record<string, readonly string[]> = {
  ...
  bon_commande_lignes: ["article_reference", "bon_commande_id", "commentaire", "cree_le", "designation", "id", "metier", "montant_ht", "position", "prix_unitaire", "quantite", "tva", "tva_categorie", "type", "unite", "unite_code"],
  bon_commande_photos: ["bon_commande_id", "chemin", "cree_le", "id", "legende", "position"],
  bons_commande: ["adresse", "adresse_locataire", "ancien_locataire", "bon_commande_parent_id", "client_id", "client_nom", "code_postal", "conducteur", "conducteur_id", "cree_le", "date", "date_fin_travaux", "date_intervention_terminee", "date_planification_initiale", "date_planifiee", "date_planifiee_fin", "date_reception", "devis_id", "duree_dernier_jour", "duree_heures", "en_attente_bc", "etage", "facturation_adresse", "facturation_code_postal", "facturation_ville", "gratuite", "gratuite_motif", "heure_dernier_jour", "heure_planifiee", "id", "interlocuteur", "legacy_id", "logement_statut", "maj_le", "metier", "metiers", "montant", "montant_par_metier", "montant_sous_traitant", "nature_travaux", "notes", "numero_bc", "numero_interne", "numero_logement", "occupant", "piece_jointe_chemin", "piece_jointe_mime", "piece_jointe_nom", "precision_commune", "probleme_description", "rappel_date", "reference_chantier", "sans_bc", "schedule_par_metier", "societe_id", "statut", "statut_workflow", "technicien", "telephone_locataire", "tentatives_contact", "ville"],
  chantier_achats: ["categorie", "chantier_id", "cree_le", "date_achat", "designation", "fichier_chemin", "fichier_nom", "fournisseur", "heures", "id", "legacy_id", "maj_le", "montant", "salarie_id"],
  ...
  chantiers: ["adresse", "client_id", "client_nom", "code_postal", "conducteur", "conducteur_id", "cree_le", "date_debut", "date_fin", "id", "infos_diverses", "legacy_id", "maj_le", "nom", "societe_id", "type", "ville"],
  clients: ["adresse", "adresse_electronique_schema", "adresse_electronique_valeur", "cadre_facturation", "code_postal", "code_routage", "code_service", "contact_email", "contact_nom", "contact_telephone", "cree_le", "delai_paiement_jours", "delai_paiement_mode", "eligibilite_message", "eligibilite_statut", "eligibilite_verifie_le", "email", "facturation_adresse", "facturation_code_postal", "facturation_pays_code", "facturation_ville", "id", "legacy_id", "livraison_adresse", "livraison_code_postal", "livraison_pays_code", "livraison_ville", "maj_le", "mode_paiement", "nom", "notes", "numero_marche", "pays_code", "reference_acheteur", "reference_engagement", "siren", "siret", "societe_id", "telephone", "tva_intracom", "ville"],
  compteurs: ["annee", "maj_le", "prefixe", "societe_id", "type", "valeur"],
  conducteurs: ["actif", "cree_le", "email", "id", "legacy_id", "maj_le", "nom", "profile_id", "salarie_id", "societe_id", "telephone"],
  devis: ["adresse", "adresse_locataire", "ancien_locataire", "chantier_id", "client_id", "client_nom", "code_postal", "conducteur", "conducteur_id", "cree_le", "date", "etage", "id", "interlocuteur", "intervention_id", "legacy_id", "logement_statut", "maj_le", "numero", "numero_logement", "occupant", "precision_commune", "remise_pourcentage", "societe_id", "statut", "telephone_locataire", "ville"],
  devis_lignes: ["article_reference", "commentaire", "cree_le", "designation", "devis_id", "id", "metier", "montant_ht", "position", "prix_unitaire", "quantite", "tva", "tva_categorie", "type", "unite", "unite_code"],
  ...
  facture_lignes: ["article_reference", "commentaire", "cree_le", "designation", "facture_id", "id", "metier", "montant_ht", "position", "prix_unitaire", "quantite", "tva", "tva_categorie", "tva_motif_exoneration", "type", "unite", "unite_code"],
  factures: ["acomptes_deduits", "adresse", "adresse_locataire", "ancien_locataire", "bon_commande_id", "cadre_facturation", "chantier_id", "client_code_routage", "client_code_service", "client_id", "client_nom", "client_pays_code", "client_siren", "client_siret", "client_tva_intracom", "code_postal", "conditions_reglement", "conducteur", "conducteur_id", "cree_le", "date", "date_fin_execution", "date_livraison", "delai_paiement_jours", "delai_paiement_mode", "depose_le", "devis_id", "devise", "echeance", "emetteur_adresse", "emetteur_code_postal", "emetteur_iban", "emetteur_nom", "emetteur_pays_code", "emetteur_siren", "emetteur_siret", "emetteur_tva_intracom", "emetteur_ville", "escompte_pourcentage", "etage", "facturation_adresse", "facturation_code_postal", "facturation_pays_code", "facturation_ville", "facture_rectifiee_id", "id", "identifiant_unique", "indemnite_recouvrement", "interlocuteur", "intervention_id", "legacy_id", "livraison_adresse", "livraison_code_postal", "livraison_pays_code", "livraison_ville", "logement_statut", "maj_le", "mode_paiement", "motif_rectification", "net_a_payer", "numero", "numero_logement", "occupant", "pdp_identifiant", "pdp_transmission_id", "penalites_retard", "precision_commune", "ref_bon_commande_client", "ref_contrat", "ref_marche", "remise_pourcentage", "retenue_garantie_pourcentage", "societe_id", "statut", "statut_cycle", "taux_change", "total_ht", "total_remise", "total_ttc", "total_tva", "tva_categorie", "tva_motif_exoneration", "tva_sur_encaissements", "type_document", "ventilation_tva", "verrouillee", "ville"],
  ...
  fournisseurs: ["actif", "adresse", "code_postal", "contact_nom", "cree_le", "email", "id", "maj_le", "nom", "notes", "siret", "societe_id", "specialite", "telephone", "ville"],
  ...
  interventions: ["adresse", "adresse_locataire", "ancien_locataire", "client_id", "client_nom", "code_postal", "conducteur", "conducteur_id", "constatations", "cree_le", "date", "etage", "heure", "id", "interlocuteur", "legacy_id", "logement_statut", "maj_le", "metier", "numero", "numero_logement", "occupant", "precision_commune", "preconisations", "signature_chemin", "societe_id", "statut", "ville"],
  invitations: ["cree_le", "cree_par", "email", "id", "invitee_le", "maj_le", "role", "salarie_id", "societe_id", "sous_traitant_id", "statut"],
  ...
  salarie_visites_medicales: ["avis", "cree_le", "date_visite", "fichier_chemin", "fichier_nom", "id", "maj_le", "medecin", "notes", "organisme", "prochaine_visite", "reserves", "salarie_id", "suivi", "type"],
