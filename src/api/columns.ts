...
const COLONNES: Record<string, readonly string[]> = {
  ...
  devis: ["adresse", "adresse_locataire", "ancien_locataire", "chantier_id", "client_id", "client_nom", "code_postal", "conducteur", "conducteur_id", "cree_le", "date", "etage", "id", "interlocuteur", "intervention_id", "legacy_id", "logement_statut", "maj_le", "numero", "numero_logement", "occupant", "precision_commune", "remise_pourcentage", "societe_id", "statut", "ville"],
