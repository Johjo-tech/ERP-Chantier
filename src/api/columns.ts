...
const COLONNES: Record<string, readonly string[]> = {
  ...
  sous_traitants: ["adresse", "code_postal", "contact_email", "contact_nom", "contact_profile_id", "cree_le", "email", "id", "legacy_id", "maj_le", "metier", "metiers", "nom", "siret", "societe_id", "telephone", "ville"],
